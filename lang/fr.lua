function FMI.lang.sets.fr()
	...
	FMI.lang.gui.reset_btn =
		string.format(FMI.lang.core.icon_template1, "/esoui/art/inventory/inventory_tabicon_junk_up.dds") .. "Reinitialiser"
	FMI.lang.gui.rtrv_btn =
		string.format(FMI.lang.core.icon_template1, "/esoui/art/hud/radialicon_trade_up.dds") .. "Scanner"
	FMI.lang.gui.find_btn =
		string.format(FMI.lang.core.icon_template1, "/esoui/art/lfg/lfg_tabicon_grouptools_up.dds") .. "Rechercher"
	FMI.lang.gui.close_btn =
		string.format(FMI.lang.core.icon_template1, "/esoui/art/hud/radialicon_cancel_up.dds") .. "Fermer"
	...
	FMI.lang.gui.search_summ =
		"%s résultat. prix unique (Max/Min/Moy/Réduit):|cff0000%s|r/|cff8000%s|r/|cfff000%s|r/|c00ff00%s|r%s" -- Max, Min, Avg, Undercut, Sell for price
