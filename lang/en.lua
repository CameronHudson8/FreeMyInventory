function FMI.lang.sets.en()
	...
	FMI.lang.gui.reset_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/inventory/inventory_tabicon_junk_up.dds").."Reset"
	FMI.lang.gui.rtrv_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_trade_up.dds").."Retrieve"
	FMI.lang.gui.ctnu_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_trade_up.dds").."Continue last search"
	FMI.lang.gui.find_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/lfg/lfg_tabicon_grouptools_up.dds").."Find Match"
	FMI.lang.gui.close_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_cancel_up.dds").."Close"
	...
	FMI.lang.gui.search_summ= "%s matches. Unit Price (Max/Min/Avg/Undercut):|cff0000%s|r/|cff8000%s|r/|cfff000%s|r/|c00ff00%s|r%s" -- Max, Min, Avg, Undercut, Sell for price
	...
	FMI.lang.config.tooltip_session_tip="If on, this will show a summary of the item sale data found for the item in the current session.  This data is broken down by guild." --added 0.06
	FMI.lang.config.tooltip_history_lbl="Show history summary?" --added 0.06
	FMI.lang.config.tooltip_history_tip="If on, this will show a summary of the item sale data found for the item across all sessions/characters.  This data is broken down by guild." --added 0.06
	...
	FMI.lang.gui.tt_Sell= "|c00FFFFSell|r in |c008000%s|r for |c00ff00%s|r"..FMI.lang.core.icon_gold.." [|cFF80FF%s|r] (|c00FFFF%s|r)"--added 0.06 - guild, price, qty, source
	FMI.lang.gui.tt_Buy= "|c00FFFFBuy|r from |c008000%s|r for |c00ff00%s|r"..FMI.lang.core.icon_gold.." [|cFF80FF%s|r] (|c00FFFF%s|r)"--added 0.06 - guild, price, qty, source
