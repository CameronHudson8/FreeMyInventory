function FMI.lang.sets.de()
	...
	FMI.lang.config_filt_markdown_tip="Die Preisempfehlung f\195\188r ein kleineres Gebot wird um den hier konfigurierten Prozentwert reduziert."
	
	--- GUI -----------------
	
	FMI.lang.gui.reset_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/inventory/inventory_tabicon_junk_up.dds").."Zur\195\188cksetzen."
	FMI.lang.gui.rtrv_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_trade_up.dds").."Einlesen"
	FMI.lang.gui.ctnu_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_trade_up.dds").."Suche fortsetzen"
	FMI.lang.gui.find_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/lfg/lfg_tabicon_grouptools_up.dds").."Suchen"
	FMI.lang.gui.close_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_cancel_up.dds").."Schlie\195\159en"
	...
	FMI.lang.gui.searchBusy=working.."|cff0000Guild Store Search Ex ist gerade mit einer anderen Suche besch\195\164ftigt, bitte warten."
	FMI.lang.gui.searchNoGS=FMI.lang.core.icon_gstoreold.."|cff0000Der Gildenladen muss geöffnet sein um eingelesen zu werden.."
	...
	FMI.lang.gui.search_summ= "%s \195\156bereinstimmungen. St\195\188ckpreis (Max/Min/Avg/Unterbieten):|cff0000%s|r/|cff8000%s|r/|cfff000%s|r/|c00ff00%s|r%s" -- Max, Min, Avg, Undercut, Sell for price
	...
	FMI.lang.config.tooltip_session_tip="Wird diese Einstellung aktiviert, so wird eine Zusammenfassung der Verkaufsdaten der Gegenst\195\164nde aus dieser Spielsitzung angezeigt. Diese Daten werden auf die Gilden heruntergebrochen." --added 0.06
	FMI.lang.config.tooltip_history_lbl="Zusammenfassung der Historie?" --added 0.06
	FMI.lang.config.tooltip_history_tip="Wird diese Einstellung aktiviert, so wird eine Zusammenfassung der Verkaufsdaten der Gegenst\195\164nde aller Spielsitzungen und Charaktere angezeigt. Diese Daten werden auf die Gilden heruntergebrochen." --added 0.06
	FMI.lang.config.tooltip_recom_lbl="Empfehlungen?" --added 0.06
	FMI.lang.config.tooltip_recom_tip="Wird diese Einstellung aktiviert, wird eine Empfehlung angezeigt, wo und f\195\188r wie viel ein Gegenstand am besten zu Kaufenw oder Verkaufen w\195\164re." --added 0.06
	
	
	
	--- Tooltips
	
	FMI.lang.gui.tt_line= "%s: |cff0000%s"..FMI.lang.core.icon_gold.."|r/|cff8000%s"..FMI.lang.core.icon_gold.."|r/|cfff000%s"..FMI.lang.core.icon_gold.."|r/|c00ff00%s"..FMI.lang.core.icon_gold.."|r" -- guild, Max, Min, Avg, Undercut -added 0.06
	...
	FMI.lang.gui.tt_Sell= "|c00FFFFVerkaufe|r in |c008000%s|r f\195\188r |c00ff00%s|r"..FMI.lang.core.icon_gold.." [|cFF80FF%s|r] (|c00FFFF%s|r)"--added 0.06 - guild, price, qty, source
	FMI.lang.gui.tt_Buy= "|c00FFFFKaufe|r bei |c008000%s|r f\195\188r |c00ff00%s|r"..FMI.lang.core.icon_gold.." [|cFF80FF%s|r] (|c00FFFF%s|r)"--added 0.06 - guild, price, qty, source
