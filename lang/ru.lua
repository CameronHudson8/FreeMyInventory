function FMI.lang.sets.ru()
	...
	FMI.lang.gui.reset_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/inventory/inventory_tabicon_junk_up.dds").."Càpocèòö"
	FMI.lang.gui.rtrv_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_trade_up.dds").."Çaïpocèòö"
	FMI.lang.gui.ctnu_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_trade_up.dds").."Ïpoäoìæèòö ïocìeäîèé ïoècê"
	FMI.lang.gui.find_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/lfg/lfg_tabicon_grouptools_up.dds").."Îaéòè coáïaäeîèü"
	FMI.lang.gui.close_btn=string.format(FMI.lang.core.icon_template1,"/esoui/art/hud/radialicon_cancel_up.dds").."Çaêpÿòö"
	...
	FMI.lang.gui.main_cmd=string.format(FMI.lang.core.icon_template1,"/esoui/art/lfg/lfg_tabicon_grouptools_up.dds").."Ïoècê ïo íaâaçèîó"
	--- Dynamics
	...
	FMI.lang.gui.searchNoGS=FMI.lang.core.icon_gstoreold.."|cff0000Âèìöäeécèêé íaâaçèî äoìæeî àÿòö oòêpÿò äìü çaïpoca peçóìöòaòoá."
	...
	FMI.lang.gui.search_summ= "%s coáïaäeîèé. Œeîa eäèîèœÿ (Íaêc/Íèî/Cpeä/Cêèä):|cff0000%s|r/|cff8000%s|r/|cfff000%s|r/|c00ff00%s|r%s" -- Max, Min, Avg, Undercut, Sell for price
	...
	FMI.lang.config.tooltip_session_tip="Ecìè áêìôùeîo, àóäeò ïoêaçÿáaòö cóííapîo ïo äaîîÿí ácex ïpoäaæ ïpeäíeòa, îaéäeîîÿí á ïpoäaæax ça òeêóûóô ceccèô.  Ëòè äaîîÿe paçàèáaôòcü ïo âèìöäèüí." --added 0.06
	FMI.lang.config.tooltip_history_lbl="Ïoêaçÿáaòö ècòopèô cóííapîo?" --added 0.06
	FMI.lang.config.tooltip_history_tip="Ecìè áêìôùeîo, àóäeò ïoêaçÿáaòö cóííapîo ïo äaîîÿí ácex ïpoäaæ ïpeäíeòa, îaéäeîîÿí á ïpoäaæax ça áce ceccèè è äìü ácex ïepcoîaæeé. Ëòè äaîîÿe paçàèáaôòcü ïo âèìöäèüí." --added 0.06
	FMI.lang.config.tooltip_recom_lbl="Ïoêaçÿáaòö peêoíeîäaœèè?" --added 0.06
	FMI.lang.config.tooltip_recom_tip="Ecìè áêìôùeîo, ïoêaçÿáaeò peêoíeîäaœèè âäe è ça cêoìöêo ìóùúe êóïèòö/ïpoäaòö ïpeäíeò." --added 0.06
	...
	FMI.lang.config.lang_warn="Áÿ äoìæîÿ áÿéòè èìè ïepeçaâpóçèòö èîòepñeéc (/reloadui), ùòoàÿ ëòè îacòpoéêè àÿìè ïpèíeîeîÿ." --added 0.09
	...
	FMI.lang.gui.tt_Sell= "|c00FFFFÏpoäaîo:|r in |c008000%s|r ça |c00ff00%s|r"..FMI.lang.core.icon_gold.." [|cFF80FF%s|r] (|c00FFFF%s|r)"--added 0.06 - guild, price, qty, source
	FMI.lang.gui.tt_Buy= "|c00FFFFÊóïìeîo:|r from |c008000%s|r ça |c00ff00%s|r"..FMI.lang.core.icon_gold.." [|cFF80FF%s|r] (|c00FFFF%s|r)"--added 0.06 - guild, price, qty, source
